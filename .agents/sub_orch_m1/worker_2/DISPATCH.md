...
2. Modify `engine/simulator.py` around lines 549-556 to consolidate winning PnL into `safe_core` when `bullet.get('pending_reset')` is True.
...
4. Execute and verify all test suites:
   ...
   - `pytest tests/`
5. Write `handoff.md` in `c:/Users/juanc/Desktop/prueba/.agents/sub_orch_m1/worker_2/handoff.md` detailing changes and test outputs.
